			  ...
			  <div class="container-fluid">
			    ...
			    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
			      <ul class="nav navbar-nav">
			        <li class="'.($menu_aktif($options,1)).'"><a href="'.site_url('dashboard').'">HOME<span class="sr-only">(Dashboard)</span></a></li>
			        <li class="dropdown '.($menu_aktif($options,2)).'">
			          ...
			          <ul class="dropdown-menu" role="menu">
			            <li><a href="'.site_url('products?addnew').'">New Produk</a></li>
			            <li><a href="'.site_url('products?aktif').'">Browse Produk</a></li>
			          </ul>
			        </li>
			        <li class="dropdown '.($menu_aktif($options,3)).'">
			          <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-expanded="false">Users<span class="caret"></span></a>
			          <ul class="dropdown-menu" role="menu">
			            <li><a href="'.site_url('users?addnew').'">New Users</a></li>
			            <li><a href="'.site_url('users?aktif').'">Browse Users</a></li>
			          </ul>
			        </li>
			        <li class="'.($menu_aktif($options,4)).'"><a href="'.site_url('invoice').'">Invoice</a></li>
			        './*<li class="dropdown">
